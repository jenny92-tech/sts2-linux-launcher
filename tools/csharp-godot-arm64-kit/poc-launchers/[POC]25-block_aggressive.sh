...
> "$EGL_SHIM_LOG_FILE"
export EGL_SHIM_BLACKLIST="glDispatchCompute:glDispatchComputeIndirect:glMemoryBarrier:glMemoryBarrierByRegion:glFramebufferTextureMultiviewOVR:glFramebufferTextureMultisampleMultiviewOVR:glDebugMessageCallback:glDebugMessageCallbackARB:glDebugMessageCallbackKHR:glDebugMessageControl:glDebugMessageControlARB:glDebugMessageControlKHR:glObjectLabel:glObjectLabelKHR:glPushDebugGroup:glPushDebugGroupKHR:glPopDebugGroup:glPopDebugGroupKHR:glTexStorage3DMultisample:glTexStorage2DMultisample:glPatchParameteri:glPatchParameterfv:glDrawElementsInstancedBaseInstance:glDrawArraysInstancedBaseInstance:glProgramUniform1iv:glProgramUniform1uiv:glProgramUniform1fv:glBindImageTexture"
